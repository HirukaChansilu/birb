    ...
    <footer>
      ...
      <div className="footer-grid">
        <div className="grid-side">
          ...
          <p>
            - Project Repo on&nbsp;
            <a href="https://github.com/HirukaChansilu/birb">Github</a>
          </p>
          <p>
            - Project Design on&nbsp;
        ...
        <div className="grid-side">
          ...
          <p>- Alexa Devices Images from various websites via Google Search</p>
          <p>
            -&nbsp;
      ...
      <div className="footer-last">
        <p>Submission for The AI Odyssey organized by VVICTS</p>
        <p>
          Hiruka Chansilu <br />
